...
export const { getAirportsData, setAirportsData, getAirportsDataError, setAirportsToAdd, addAirportsToDb, deleteAirport, deleteAirportError, changeAirport, changeAirportError } = createActions({
